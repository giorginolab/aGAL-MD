...
def rmsd(filename=str, topology=str, trajectory=str, refmol=str, trajrmsdstr=str, trajalnstr=None, refrmsdstr='protein and name CA', refalnstr = 'protein and name CA' ,centerstr = 'protein and name CA', title = False):
    """
    ...
    fig.savefig(f"../results/{filename}_rmsd.pdf", dpi=300)
    plt.show()
